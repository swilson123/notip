        ...
        if (rover.mission.path_clear) {
            ...
            if (waypoint.latitude && waypoint.longitude) {
                ...
                if (Math.abs(rover.robot_data.yaw_to_waypoint) > 20) {
                    ...
                    rover.servo_send_command(rover, 11, steer_pwm.servo2);
                    rover.servo_send_command(rover, 13, steer_pwm.servo1);
                    ...
                    setTimeout(() => {
                        rover.move_rover(rover, 2, motor_speed_cmd, "run_mission");
                    }, 20);
                    setTimeout(() => {
                        rover.move_rover(rover, 3, motor_speed_cmd, "run_mission");
                    }, 30);
                    setTimeout(() => {
                        rover.move_rover(rover, 4, motor_speed_cmd * -1, "run_mission");
                    }, 40);
